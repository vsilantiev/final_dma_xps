/*****************************************************************************
* Filename:          /home/vladimir/cf_ad9467_zed/drivers/fuck_v1_00_a/src/fuck.c
* Version:           1.00.a
* Description:       fuck Driver Source File
...
void FUCK_MasterRecvWord(Xuint32 BaseAddress, Xuint32 SrcAddress)
{
   ...
   */
  Xil_Out8(BaseAddress+FUCK_MST_CNTL_REG_OFFSET, MST_SGRD);

  /*
   * Set user logic master address register to drive IP2Bus_Mst_Addr signal.
   */
  Xil_Out32(BaseAddress+FUCK_MST_ADDR_REG_OFFSET, SrcAddress);
