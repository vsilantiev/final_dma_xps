/*****************************************************************************
* Filename:          /home/vladimir/cf_ad9467_zed/drivers/a_v1_00_a/src/a.c
* Version:           1.00.a
* Description:       a Driver Source File
...
void A_MasterRecvWord(Xuint32 BaseAddress, Xuint32 SrcAddress)
{
   ...
   */
  Xil_Out8(BaseAddress+A_MST_CNTL_REG_OFFSET, MST_SGRD);

  /*
   * Set user logic master address register to drive IP2Bus_Mst_Addr signal.
   */
  Xil_Out32(BaseAddress+A_MST_ADDR_REG_OFFSET, SrcAddress);
